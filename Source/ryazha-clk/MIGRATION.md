...
API version reference must be changed. compare to RCLK_IPC_API_VERSION
If you use the service name, use RCLK_IPC_SERVICE_NAME
...
Your project is now migrated to run with Ryazha-CLK
